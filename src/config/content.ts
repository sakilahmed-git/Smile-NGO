export const impactStats = [
  { label: "children supported", value: "12,840" },
  { label: "community programs", value: "46" },
  { label: "verified donations", value: "₹38.6L" },
...
export const projects = [
  {
    ...
    category: "Education",
    summary:
      "Mobile-first after-school labs with tutors, tablets and safe learning spaces for first-generation learners.",
    location: "Patna and nearby rural blocks",
    progress: 78,
    metric: "4,200 learners reached",
    imageSrc: "/gallery/community/learning-lab.svg",
  },
  {
    slug: "nutrition-circle",
    title: "Nutrition Circle",
    category: "Health",
    summary:
      "Monthly nutrition kits, health screening camps and counselling for children, mothers and elderly residents.",
    location: "Urban settlements",
    progress: 64,
    metric: "18,600 meals enabled",
  ...
  },
  {
    ...
    category: "Relief",
    summary:
      "Rapid distribution of hygiene, menstrual care, blankets and school essentials with verified beneficiary lists.",
    location: "Flood-prone communities",
    progress: 52,
    metric: "7,900 families served",
    imageSrc: "/gallery/community/volunteer-day.svg",
  },
];
