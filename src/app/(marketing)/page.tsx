...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="page-shell grid gap-0 pb-0 md:grid-cols-[1.05fr_.95fr] md:items-center md:pt-8">
        ...
        <div className="mt-4 rounded-2xl border border-emerald-100 bg-white p-4 shadow-[0_12px_35px_rgba(6,78,59,0.08)]">
  <div className="flex items-center justify-between gap-3">
    ...
    <a
      ...
      className="rounded-full bg-gradient-to-r from-[#07543D] to-[#159A70] px-4 py-2.5 text-xs font-bold text-white shadow-sm"
    >
      Call Helpline
    </a>
  </div>
</div>
        <div className="flex flex-col justify-center align- items-center p-3">
  ...
  {latestActivity.map((item) => (
    <article
      key={item.title}
      className="soft-card flex h-full flex-col"
    >
      {item.showQr ? (
      ...
      <div className="relative">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          {[
            ...
            <div
              key={item}
              className="flex items-center gap-2 rounded-xl bg-[#F3F9F6] px-3 py-2.5 text-xs font-medium text-[var(--color-brand-strong)]"
            >
    ...
    <article className="relative overflow-hidden rounded-[var(--radius-lg)] bg-gradient-to-br from-[#07543D] via-[var(--color-brand)] to-[#159A70] p-6 text-white shadow-soft md:p-8">
      ...
      <div className="relative flex h-full flex-col">
        <div className="flex items-center justify-between">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#F1D080]">
            Founder&apos;s desk
          </p>

          <div className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-medium text-white/80">
            SMILE NGO
          </div>
        </div>
...
<section className="page-shell">
  ...
  <div className="mt-8 grid gap-5 md:grid-cols-2">
    {financialYearImpact.years.map((year) => (
      <article
        key={year.year}
        className="group overflow-hidden rounded-[1.8rem] border border-emerald-900/5 bg-white shadow-[0_12px_35px_rgba(6,78,59,0.07)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(6,78,59,0.12)]"
      >
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#063F30] via-[#087653] to-[#229C73] px-5 py-5 text-white">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <div className="grid h-11 w-11 place-items-center rounded-xl border border-white/15 bg-white/10 text-[#F1D080] backdrop-blur">
        ...
        <div className="grid gap-2.5 p-4">
          {year.stats.map((stat) => (
            ...
            >
              ...
              <strong className="whitespace-nowrap text-base font-bold text-[#087653]">
                {stat.value}
              </strong>
            </div>
          ))}
...
<section className="page-shell">
  ...
  <div className="content-grid mt-8">
    {managementTeam.map((member) => (
      <article
        key={member.name}
        className="group relative overflow-hidden rounded-[var(--radius-lg)] bg-white p-5 text-center shadow-soft ring-1 ring-emerald-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(6,78,59,0.10)]"
      >
        {/* subtle top accent */}
        <div
          aria-hidden
        ...
        <div className="mt-4">
          ...
          <p className="mt-1 text-xs font-semibold uppercase tracking-[0.08em] text-[var(--color-brand-strong)]">
            {member.role}
          </p>
        </div>
